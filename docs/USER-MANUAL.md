...
- Username: `admin`
- Password: `JC2026!Init` (หรือที่เปลี่ยนไว้)
...
ระบบดั้งเดิมของ HR-WWN คือการสัมภาษณ์พนักงานเพื่อสร้างเอกสาร 3 ฉบับ:
...
### 13.1 ภาพรวม
HR-WWN พร้อม deploy ออนไลน์แบบฟรีผ่าน **Cloudflare Tunnel**:
...
### 13.4 หมายเหตุสำคัญ
- **ลืม master password** → ต้องแก้ไฟล์ `data/auth.json` โดยตรง (ลบทั้งไฟล์ → server จะสร้างใหม่ด้วย default `JC2026!Init`)
